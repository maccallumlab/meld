...
An example analysis script is provided in `analyze_distograms <https://github.com/ccccclw/meld/blob/del_simtk/docs/tutorial/use_histogram/analyze_distograms.py>`. 
...
The full sample setup script can be found in `setup_MELD <https://github.com/ccccclw/meld/blob/del_simtk/docs/tutorial/use_histogram/setup_MELD.py>`. 
